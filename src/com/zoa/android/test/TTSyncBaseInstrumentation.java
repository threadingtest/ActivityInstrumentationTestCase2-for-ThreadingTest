...
public class TTSyncBaseInstrumentation extends SyncBaseInstrumentation {
    ...
    protected void setUp() throws Exception {
	    ...
	    Log.v("TTSyncBaseInstrumentation", "start");
    }
    ...
    protected void tearDown() throws Exception {
        if(zoa_t != null)
        {
        	Log.v("TTSyncBaseInstrumentation", "close");
        	zoa_t.close();		// close TT Unit Test
        }
        else
        {
        	Log.e("TTSyncBaseInstrumentation", "close error");
        }
        super.tearDown();
    }
}
